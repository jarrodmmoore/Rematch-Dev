...
scoreboard players set @e[name=Global] playerSpawn 1

execute unless entity @e[scores={loadingTimeout=240..},name=Global] as @a[sort=random,team=players] at @s run function rematch:game/pvp/find_spawnpoints/player_find
