summon minecraft:armor_stand ~ ~ ~ {Tags:["phase3trap","tnttrap","shortrange","setme"],DisabledSlots:4144959,NoGravity:1b,Invulnerable:1b,Small:1b,Invisible:1b}

particle minecraft:falling_dust{block_state:{Name:"minecraft:tnt"}} ~ ~.2 ~ 0.3 0.0 0.3 1 20
particle minecraft:smoke ~ ~.2 ~ 0.3 0.0 0.3 .1 5
