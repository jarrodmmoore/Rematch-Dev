summon minecraft:armor_stand ~ ~ ~ {Tags:["phase3trap","slownesstrap","shortrange","setme"],NoGravity:1b,Invulnerable:1b,Small:1b,Invisible:1b,DisabledSlots:4144959}

particle minecraft:falling_dust{block_state:{Name:"minecraft:gray_wool"}} ~ ~.2 ~ 0.3 0.0 0.3 1 20
