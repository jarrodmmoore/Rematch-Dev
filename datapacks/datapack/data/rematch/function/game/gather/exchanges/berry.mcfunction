...
execute if entity @e[scores={eventScore=3},name=Global,type=armor_stand,x=0,y=50,z=49,dx=1,dy=1,dz=1] run scoreboard players operation @e[tag=currencystand,scores={math=0}] math2 *= @e[limit=1,name=Global,type=armor_stand,x=0,y=50,z=49,dx=1,dy=1,dz=1] x2
...
scoreboard players add @s berries_picked 1
...
clear @s minecraft:player_head[minecraft:custom_name='"Berry"',minecraft:item_name='{"extra":["Berry"],"text":"EMU"}',minecraft:custom_data={emu_lock_name:'"Berry"'}]
