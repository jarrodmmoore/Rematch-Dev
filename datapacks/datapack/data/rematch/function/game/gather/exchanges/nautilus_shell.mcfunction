...
scoreboard players add @e[tag=currencystand,scores={math=0}] math2 100
execute if entity @e[scores={eventScore=5},name=Global] run scoreboard players operation @e[tag=currencystand,scores={math=0}] math2 *= @e[limit=1,name=Global] x4
