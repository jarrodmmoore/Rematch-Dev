...
execute if entity @e[scores={eventScore=2},name=Global,type=armor_stand,x=0,y=50,z=49,dx=1,dy=1,dz=1] at @s if entity @e[type=minecraft:armor_stand,distance=..100,tag=bookshelf_farm] run scoreboard players operation @e[tag=currencystand,scores={math=0}] math2 *= @e[limit=1,name=Global,type=armor_stand,x=0,y=50,z=49,dx=1,dy=1,dz=1] x2
execute if entity @e[scores={eventScore=3},name=Global,type=armor_stand,x=0,y=50,z=49,dx=1,dy=1,dz=1] at @s if entity @e[type=minecraft:armor_stand,distance=..100,tag=bookshelf_forest] run scoreboard players operation @e[tag=currencystand,scores={math=0}] math2 *= @e[limit=1,name=Global,type=armor_stand,x=0,y=50,z=49,dx=1,dy=1,dz=1] x2
