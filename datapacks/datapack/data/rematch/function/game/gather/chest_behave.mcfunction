...
execute at @s facing entity @a[sort=nearest,limit=1,team=!spectators] eyes rotated ~ 0 run function help:9434173352d908a1dddddbb2b108582f21cd249b67832f64227714b8889f61a0
return 1