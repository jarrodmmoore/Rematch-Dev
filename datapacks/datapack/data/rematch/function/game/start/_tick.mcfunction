...
scoreboard players set @e[scores={readyRequired=..1},name=Global] readyRequired 2

#calculate ready players
scoreboard players set @e[name=Global] readyDummy 0
execute as @a[tag=readyup,team=!spectators] run scoreboard players add @e[name=Global] readyDummy 1
...
execute if entity @e[scores={readyDummy=0..,readyState=..0},name=Global] run function rematch:game/start/set_mode_ready
execute if entity @e[scores={readyState=..0},name=Global] if entity @a[tag=admin,tag=readyup] run function rematch:game/start/set_mode_ready
execute if entity @e[scores={readyDummy=..-1,readyState=1..},name=Global] unless entity @a[tag=admin,tag=readyup] run function rematch:game/start/set_mode_not_ready
#######################

#logic depending on readyState
execute if entity @e[scores={readyState=..0},name=Global] run function rematch:game/start/_tick_not_ready
execute if entity @e[scores={readyState=1..},name=Global] run function rematch:game/start/_tick_ready
