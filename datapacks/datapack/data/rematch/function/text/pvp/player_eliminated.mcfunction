...
execute if entity @e[scores={playerCountA=2..},name=Global] run tellraw @a ["",{"score":{"name":"@e[limit=1,name=Global]","objective":"playerCountA"},"italic":true,"type":"score"},{"text":" players remain.","italic":true,"type":"text"}]
tellraw @a ["",{"text":" ","type":"text"}]
return 1